...
int my_printf(char *src, ...)
{
    void (*tabPrintf[13]) (va_list *) = {my_printf_str, my_printf_nbr,
                my_printf_char, my_printf_nbr_octal, my_printf_nbr_hexa,
                my_printf_nbr_hex, my_printf_nbr_u, my_printf_nbr_binary,
                double_pourcent, my_printf_p, my_printf_s, my_printf_nbr};
